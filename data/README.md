...
The world is split in two at the top level:

- **`config/`** holds everything that defines how the assistant behaves —
  behaviour, commands, cron jobs, learned APIs, installed realms, skills, types,
  channels, webhooks, etc. Reset wipes and reseeds this from the default-world template.
...
to nuke everything including data, delete the world.
